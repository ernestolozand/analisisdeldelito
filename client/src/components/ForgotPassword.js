  ...
  const sendEmail = async (e) => {
    ...
    try {
      ...
      // }
        ...
        await axios.post("http://localhost:3000/ForgotPassword", { email, OTP })
          .then(res => {
            if (res.data == 'pass') {
              ...
              toast.error("Usuario no encontrado! Por favor regístrate")
            }
        ...
        <div className="z-20 fixed top-0 left-0 right-0 bottom-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-lg p-6 shadow-xl">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-semibold">Introducir código</h2>
            ...
            <p className="text-md mt-4">Ingresa el código de 6 dígitos enviado a su correo electrónico.</p>
      ...
      <form onSubmit={sendEmail} className='mb-4' >
        <section className="text-gray-600 mt-14 body-font grid place-items-center  relative  ">
          ...
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col   mt-10 md:mt-0 relative z-10 shadow-md">
            <h2 className="text-gray-900 text-2xl mb-5 font-medium title-font">¿Olvidaste tu contraseña?
            </h2>
            ...
            <input className="mt-3 cursor-pointer text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" type="submit" value={"Continuar"} />
            <p className="text-base text-blue-700 mt-3"><Link to={"/login"}>Iniciar sesión</Link> </p>
