...
export default function Contact() {
    ...
    if (state.succeeded) {
        return <div className='suceed'>
            <div>
                <p className='text-3xl text-center mx-auto mt-11 py-2 px-8'>Su mensaje fue enviado exitosamente.</p>
                    ...
                    <div class="container px-5 py-24 mx-auto">
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                    <button type='submit' class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Enviar información</button>
                                </div>
